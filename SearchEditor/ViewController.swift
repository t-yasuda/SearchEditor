...
class ViewController: UIViewController, UITextFieldDelegate, UICollectionViewDataSource, SiteCollectionViewCellDelegate, UICollectionViewDelegate {
    ...
    func loadSite(){
        ...
        if ud.array(forKey: "siteArray") != nil {
            ...
            siteDatas = [
                ["title": "goo(sample)", "url": "https://search.goo.ne.jp/web.jsp?MT=[QUERY]&IE=UTF-8&OE=UTF-8"],
                ["title": "amazon(sample)", "url": "https://www.amazon.co.jp/gp/search?ie=UTF8&keywords=[QUERY]"],
            ]
        }
    }
